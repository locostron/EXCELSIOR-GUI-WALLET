...
config.appName = 'excelsior Wallet';
config.appDescription = 'excelsior Wallet';
config.appSlogan = 'Slow and steady wins the race!';
config.appId = 'lol.excelsior.walletshell';
...
config.walletFileDefaultExt = 'XLS';
...
config.remoteNodeDefaultHost = '185.103.97.205';
